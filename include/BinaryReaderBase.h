...
public:
	...
	uint8_t*	readUInt8Array(size_t count);
	uint8_t*	readUInt8Array(size_t count, uint8_t min, uint8_t max, const std::string& debugMsg);
	...
	int8_t*		readInt8Array(size_t count);
	int8_t*		readInt8Array(size_t count, int8_t min, int8_t max, const std::string& debugMsg);
	...
	uint16_t*	readUInt16Array(size_t count);
	uint16_t*	readUInt16Array(size_t count, uint16_t min, uint16_t max, const std::string& debugMsg);
	...
	int16_t*	readInt16Array(size_t count);
	int16_t*	readInt16Array(size_t count, int16_t min, int16_t max, const std::string& debugMsg);
	...
	uint16_t*	readUInt16BEArray(size_t count);
	uint16_t*	readUInt16BEArray(size_t count, uint16_t min, uint16_t max, const std::string& debugMsg);
	...
	int16_t*	readInt16BEArray(size_t count);
	int16_t*	readInt16BEArray(size_t count, int16_t min, int16_t max, const std::string& debugMsg);
	...
	uint32_t*	readUInt32Array(size_t count);
	uint32_t*	readUInt32Array(size_t count, uint32_t min, uint32_t max, const std::string& debugMsg);
	...
	int32_t*	readInt32Array(size_t count);
	int32_t*	readInt32Array(size_t count, int32_t min, int32_t max, const std::string& debugMsg);
	...
	uint32_t*	readUInt32BEArray(size_t count);
	uint32_t*	readUInt32BEArray(size_t count, uint32_t min, uint32_t max, const std::string& debugMsg);
	...
	int32_t*	readInt32BEArray(size_t count);
	int32_t*	readInt32BEArray(size_t count, int32_t min, int32_t max, const std::string& debugMsg);
	...
	uint64_t*	readUInt64Array(size_t count);
	uint64_t*	readUInt64Array(size_t count, uint64_t min, uint64_t max, const std::string& debugMsg);
	...
	int64_t*	readInt64Array(size_t count);
	int64_t*	readInt64Array(size_t count, int64_t min, int64_t max, const std::string& debugMsg);
	...
	uint64_t*	readUInt64BEArray(size_t count);
	uint64_t*	readUInt64BEArray(size_t count, uint64_t min, uint64_t max, const std::string& debugMsg);
	...
	int64_t*	readInt64BEArray(size_t count);
	int64_t*	readInt64BEArray(size_t count, int64_t min, int64_t max, const std::string& debugMsg);
	...
	float*		readHalfArray(size_t count);
	float*		readHalfArray(size_t count, float min, float max, uint8_t flags, const std::string& debugMsg);
	...
	float*		readFloatArray(size_t count);
	float*		readFloatArray(size_t count, float min, float max, uint8_t flags, const std::string& debugMsg);
	void		readFloatArray(float* ptr, size_t count);
	void		readFloatArray(float* ptr, size_t count, float min, float max, uint8_t flags, const std::string& debugMsg);

	double*		readDoubleArray(size_t count);
	double*		readDoubleArray(size_t count, double min, double max, uint8_t flags, const std::string& debugMsg);
	...
	virtual BinaryReaderBase& seek(std::streamoff offset, std::ios_base::seekdir way) = 0;
